...
class SideDrawer<T> extends StatefulWidget {
  SideDrawer({
    ...
    this.direction = DrawerDirection.left,
    this.selectorColor,
  ...
  /// DrawerDirection the drawer will appear ([DrawerDirection.left] or [DrawerDirection.right])
  /// Default: [DrawerDirection.left]
  ...
  Widget createDrawer(MenuController? menuController) {
    ...
    return Transform(
      transform: Matrix4.translationValues(
        widget.slide
            ? (widget.direction == DrawerDirection.left ? 1 : -1) *
